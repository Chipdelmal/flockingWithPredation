...
to-report randomAngleRange[rangeA]
  ;;Returns an angle in the range of (-range, range)
  report random rangeA - random rangeA
end

;;FlockingFunctions---------------------------------------------------------------------------------------------------
to flock [flockingBreed radius angle baseSpeed speedPerFlockmate noiseInMovement]
  ...
  if(flockSpeed = "BaseSpeed")[set individualSpeed baseSpeed + (speedPerFlockmate * count flockmates)]
...
"" ""
PENS
"deadTurtles" 1.0 0 -16777216 true "" "plot deadTurtles"
"turtlesFlocking" 1.0 0 -2674135 true "" "plot count doves with [any? flockmates]"
"ratioTurtlesFlocking" 1.0 0 -8630108 true "" "ifelse(count doves > 0)[plot (count doves with [any? flockmates]) / (count doves) * 100][plot 0]"
"meanSpeed" 1.0 0 -7500403 true "" "ifelse(count doves > 0)[plot (mean [individualSpeed] of doves) * 100][plot 0]"
...
flockSpeed
flockSpeed
"BaseSpeed" "MinOfFlock" "MeanOfFlock" "MaxOfFlock"
0
...
### Entities
Hawks (in red): predators
Doves (in other colors): prey
...
<experiments>
  <experiment name="Baseline" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="noiseInMovement">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="maxSeparateTurn">
      <value value="1.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="population">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="maxAlignTurn">
      <value value="3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="minimumDistance">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="vision">
      <value value="3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="visionAngle">
      <value value="360"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="maxCohereTurn">
      <value value="3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="lonelySpeed">
      <value value="0.1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="speedPerFlockmate">
      <value value="0"/>
    </enumeratedValueSet>
